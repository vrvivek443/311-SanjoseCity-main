...
const MissedCollections = () => {
  ...
  if (showSuccess) {
    return (
      <>
        ...
        <AlertNavigation
          description={[
            "Your reference ID# is 260521-000010.",
            "Your neighborhood service provider will reach out to you directly by phone within one business day.",
          ]}
  ...
  return (
    <div className="container mt-3 mb-4">
      <h4 className="fw-bold mb-4 mc-title">Report Missed Collection</h4>
...
export default MissedCollections;
